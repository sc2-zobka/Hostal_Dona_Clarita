...
def login(request):
    ...
    return render(request, 'appADM/registration/login.html', data)
...
def registro(request):
    ...
    return render(request, 'appADM/registration/registro.html', data)
        ...
        try:
            cursor.execute(f"""
             SELECT E.USUARIO_ID AS '0',(E.RUT_EMPLEADO ||'-'|| E.DV) AS '1',E.NOMBRES AS '2', E.APELLIDO_P AS '3', E.APELLIDO_M AS '4',
                ...
                E.NACIMIENTO AS '8', E.NACIONALIDAD AS '9', E.COMUNA_ID AS '10', E.DIRECCION AS '11'
            FROM APP_EMPLEADO E
                ...
                with connection.cursor() as cursor:
                    try:
                        cursor.execute(f"""UPDATE APP_CONFIGURACION SET RAZON_SOCIAL = '{r_social}',
                            ...
                            DIRECCION = '{direccion}',                                               
                            COMUNA_ID = '{comuna}' , LOGO_EMPRESA = '{nom}' , FAVICON = '{nom2}'
